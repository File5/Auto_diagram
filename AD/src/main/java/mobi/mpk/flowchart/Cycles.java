		...
		for (Coords iter : Coord.breakingList) {
			if(y<iter.getY()){
				...
				if(bobtry(iter.getX(), Coord.getextremeRX(), iter.getY(),pixels,g2d)){
					...
					drawCenteredString(g2d, breakinthelaw.toString(), iter.getX()+18, iter.getY());
					int m = 0;
					...
					drawCenteredString(g2d, breakinthelaw.toString(), Coord.getextremeRX()-18, iter.getY());
					...
					breakinthelaw = breakinthelaw.intValue()+ 1;
				}	
		...
		for (Coords iter : Coord.continueList) {
			if(y<iter.getY()){
				...
				if(bobtry(Coord.getextremeLX(),iter.getX(),iter.getY(),pixels,g2d)) {
					...
					drawCenteredString(g2d, breakinthelaw.toString(), Coord.getextremeLX()+18, iter.getY());
